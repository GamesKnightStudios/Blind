...
lcc -Wa-l -Wl-m -Wl-j -DUSE_SFR_FOR_REG -Wl-yt1 -Wl-yo4 -Wl-ya0 -o build\space.gb build\main.o build\SpaceBgMap.o build\SpaceBgTiles.o build\SpaceShipTiles.o build\output.o build\gbt_player.o build\gbt_player_bank1.o
